...
import com.edutechdeveloper.rohinivpn.vpn.MainApplication;
import com.edutechdeveloper.rohinivpn.vpn.fragments.ServersFragment;
import com.edutechdeveloper.rohinivpn.vpn.nativeTemplete.NativeTemplateStyle;
import com.edutechdeveloper.rohinivpn.vpn.nativeTemplete.TemplateView;
import com.edutechdeveloper.rohinivpn.vpn.utils.Converter;
...
//    Lottie Variebles Ended
    ...
    public void go_pro_click() {
        if (Config.isIAPConnected) {
            ...
            Toast.makeText(this, "Unable to connect with billing.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void showRegionDialog() {
        ...
        if (!Config.isVPNConnected) {
            ...
            Toast.makeText(this, "Please disconnect the VPN first", Toast.LENGTH_SHORT).show();
        }
    ...
    public void onConnectBtnClick(View v) {
        ...
        connection_btn_block.setVisibility(View.GONE);
            ...
            public void success(@NonNull VPNState vpnState) {
                ...
                switch (vpnState) {
                    case IDLE: {
                        ...
                        connection_btn_block.setVisibility(View.VISIBLE);
                        vpn_connection_time.setVisibility(View.VISIBLE);
                        vpn_connection_time.setText("START");
...
//            Application settings...
            ...
            case R.id.nav_policy:
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(this, "Please give a valid privacy policy URL.", Toast.LENGTH_SHORT).show();
                }
                break;
        }
//        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
